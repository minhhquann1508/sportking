...
<body>
        ...
        <section class="container-xxl contact-section">
        <div class="row d-flex align-items-stretch">
            <div class="col-lg-6 col-md-6 col-12 d-flex flex-column justify-content-between p-4">
            ...
            <div class="col-lg-6 col-md-6 col-12 d-flex flex-column justify-content-between p-4 bg-white">
